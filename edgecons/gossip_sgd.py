...
class GossipSGD(SGD):
    def __init__(self, name, nodes, device, model, interval=10, offset=0,
                 lr=0.002, momentum=0, dampening=0, weight_decay=0, nesterov=False):
        super(GossipSGD, self).__init__(model.parameters(),
                                        lr, momentum, dampening, weight_decay, nesterov)
        self._contract = Contract(
            name, nodes, device, model, interval, offset, is_dual=False)
